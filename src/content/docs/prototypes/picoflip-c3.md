...
An extremely tiny ESP32-C3 board for WLED and ESPHome with a mezzanine connector under its USB-C port for GPIO add-ons. First prototype enumerated but would not boot into firmware; board re-wired in EasyEDA. Add-on boards exist: the 5-way from Le'Dongle and a 4-button key-fob design with sleep interrupts.

Needs the next proto run and a production quote, add-on boards included.

Public page: wiki.vdbx.io/coming-soon-ish/picoflip-c3
